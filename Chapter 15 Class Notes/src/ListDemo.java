...
public class ListDemo
{
    public static void main(String[] args)
    {
         ...
         * The | is used to represent iterator pos
        */
        ...
        /* The next method also returns the element that the itertor passes over */
        ...
        /* Enhanced for loops work with linked lists as well */
        for (String n: staff) {
            System.out.print(n + " ");
        }
        System.out.println();
        ...
        // Embedded iterator when for loop is created
        for (String n: staff) {
            if (n.equals("Tony")) {
                staff.add("T'Challa");
            }
